...
export function BarChart() {
  return (
    <>
      <div>
        <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-t-[#19d21f] darl:shadow-green-900/10 dark:bg-gray-900 dark:border-t-green-600">
